...
| File/Dir | Reason |
|----------|--------|
| `docs/com.lanser.clawnews.morning.plist` | Hardcoded `/Users/lanser/` path |
| `docs/com.lanser.clawnews.evening.plist` | Hardcoded `/Users/lanser/` path |
| `docs/com.lanser.clawnews.plist` | Hardcoded `/Users/lanser/` path |
...
- `LICENSE` — MIT
- `docs/com.lanser.clawnews.morning.plist.example`
- `docs/com.lanser.clawnews.evening.plist.example`
